...
import { toggleDisplayNavigation, toggleHideNavigation } from "../actions/AuthActions";
...
const EntryPage: React.FC = (props: any) => {
  ...
  return (
    <IonPage>
      ...
      <IonContent >
        <MapComponent
          className="headerMapComponent"
          coordinance={props.singleEntry.coordinance}
          isUserIsAdmin={isUserAdminCheck}
          currentTeam={props.teamId}
          toggleNavigation={() => props.toggleDisplayNavigation()}
        />
        <Modal
...
export default connect(mapStateToProps,
  { getSingleEvent, resetSingleEntry, addAttendanceResponse, getAttendance, getAllAttendees, toggleHideNavigation, toggleDisplayNavigation })(EntryPage);
